import{_ as s,o as i,c as a,b as e,a as n}from"./app-1f8a5ff3.js";const l="/msz-blog/assets/1695648548975-5ba054e2.png",r="/msz-blog/assets/1696688429271-62339674.png",d="/msz-blog/assets/1696689291630-c889e400.png",v="/msz-blog/assets/1696689415899-a5d18151.png",c="/msz-blog/assets/1697885689495-253d090a.png",t="/msz-blog/assets/1697886265614-03502122.png",m="/msz-blog/assets/1697887161764-3adbbf72.png",u="/msz-blog/assets/1697887193289-9838a4e5.png",b="/msz-blog/assets/1697887555685-fac7e587.png",o={},p=e('<h2 id="一-低版本mysql实现窗口函数" tabindex="-1"><a class="header-anchor" href="#一-低版本mysql实现窗口函数" aria-hidden="true">#</a> 一.低版本MySql实现窗口函数</h2><h2 id="_1-问题" tabindex="-1"><a class="header-anchor" href="#_1-问题" aria-hidden="true">#</a> 1.问题</h2><p>低版本的MySql ，无法使用,rank（）,row_number（）等其它窗口函数。</p><h2 id="_2-解决方案" tabindex="-1"><a class="header-anchor" href="#_2-解决方案" aria-hidden="true">#</a> 2.解决方案</h2><p>测试表：<img src="'+l+`" alt="1695648548975"></p><h3 id="_1-row-number" tabindex="-1"><a class="header-anchor" href="#_1-row-number" aria-hidden="true">#</a> 1.row_number()</h3><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>-- MySql8.0中的row_number（）函数，可以使用变量来实现。
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-sum-over" tabindex="-1"><a class="header-anchor" href="#_2-sum-over" aria-hidden="true">#</a> 2.SUM() OVER()</h3><p>测试表：<img src="`+r+`" alt="1696688429271"></p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>-- -----视图_转换格式
...
GROUP BY a.TBZS
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p><img src="`+m+`" alt="1697887161764"></p><hr><p><strong>视图2：</strong></p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>-- 视图2
