import{_ as n,o as s,c as a,b as t}from"./app-3bb1037e.js";const p="/assets/1695307028884-c4dbecc4.png",e="/assets/1695307264669-435e0ec9.png",c={},o=t('<h2 id="状态模式-state-pattern" tabindex="-1"><a class="header-anchor" href="#状态模式-state-pattern" aria-hidden="true">#</a> <strong>状态模式（State Pattern）</strong></h2><p><strong>状态模式：对有状态的对象，把复杂的“判断逻辑”提取到不同的状态对象中，允许状态对象在其内部状态发生改变时改变其行为。</strong></p><p>在状态模式（State Pattern）中，类的行为是基于它的状态改变的。这种类型的设计模式属于行为型模式。</p><p>在状态模式中，我们创建表示各种状态的对象和一个行为随着状态对象改变而改变的 context 对象。</p><hr><h3 id="_1-反例" tabindex="-1"><a class="header-anchor" href="#_1-反例" aria-hidden="true">#</a> <strong>1.反例</strong></h3><p>【例】通过按钮来控制一个电梯的状态，一个电梯有开门状态，关门状态，停止状态，运行状态。每一种状态改变，都有可能要根据其他状态来更新处理。例如，如果电梯门现在处于运行时状态，就不能进行开门操作，而如果电梯门是停止状态，就可以执行开门操作。类图如下：</p><p><img src="'+p+`" alt="1695307028884"></p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">//电梯接口</span>
